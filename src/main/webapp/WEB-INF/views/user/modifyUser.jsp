   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="form-horizontal" id="sendfrm" role="form" action="${cp}/user/modifyUser" method="POST"
            enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                     <label class="control-label" for="reg_dt"><fmt:formatDate value="${user.reg_dt}" pattern="yyyy.MM.dd"/></label>
                     <input type="hidden" id="reg_dt" value="<fmt:formatDate value="${user.reg_dt}" pattern="yyyy.MM.dd"/>">
                  </div>
               </div>
